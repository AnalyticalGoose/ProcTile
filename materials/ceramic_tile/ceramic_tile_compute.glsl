...
void main() {
    ...
    if (params.stage == 1.0) {
        ...
        vec3 noise_normals = sobel_filter(ivec2(pixel), params.noise_sobel_strength , params.texture_size, true);
        vec3 grout_normals = sobel_filter(ivec2(pixel), grout_sobel_strength, params.texture_size, false);
